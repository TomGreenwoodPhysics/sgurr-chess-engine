...
|------|--------|--------|------|-------|-------|----|------|----------|-------|
| 2026-09-26 | Sgurr v9.4 "Dearg" | 3322 | 12 | 1840 | +594 =703 -543 | 10+0.1 | pool-2026-09-F | Ryzen 7 7800X3D, 7 threads | **3322.0 ±11.5**, **+64.7 ±14.5 over v9.3 in the same solve**, against +54.9 ±13.3 in self-play. Played as v9.3-rc2 with `sprt_batch_c.exe`, which has the same search as the release binary: v9.3 with its time management rebuilt around a per-move budget and a hard maximum. 115 games against each of the 16 families. One abnormal ending, a time loss by MrBob. Interval is sampling only. The anchors imply ratings for this version about 30 Elo apart beyond sampling noise, which leaves about ±15 of systematic, and 42 to 49 apart for the three versions below, about ±20 to ±24. |
| 2026-09-26 | Sgurr v9.3 "Dearg" | 3257 | 9 | 3372 | +800 =1272 -1300 | 10+0.1 | pool-2026-09-F | Ryzen 7 7800X3D, 7 threads | **3257.3 ±8.8**, **+48.0 ±12.4 over v9.2 in the same solve.** Played as v9.3-rc1: its pool-E games in the row further down, plus 210 against each of the seven new families with the same binary. The registered prediction was 3266, band 3242 to 3290. No abnormal endings. |
| 2026-09-26 | Sgurr v9.2 "Dearg" | 3209 | 9 | 3458 | +721 =1081 -1656 | 10+0.1 | pool-2026-09-F | Ryzen 7 7800X3D, 7 threads | **3209.3 ±8.7**, **+43.1 ±12.9 over v9.1 in the same solve.** Played as v9.2-rc: its pool-E games plus 210 against each new family with `sgr_v92rc.exe`. No abnormal endings. |
| 2026-09-26 | Sgurr v9.1 "Dearg" | 3166 | 10 | 3369 | +591 =921 -1857 | 10+0.1 | pool-2026-09-F | Ryzen 7 7800X3D, 7 threads | **3166.2 ±9.5**, the pool-F baseline: its pool-E games plus 210 against each new family, with the binary and net of the rows below. Pool-F reads 40.0 lower than pool-D and 19.4 lower than pool-E alone. Pool-F is pool-E plus seven families, sixteen in all from 3087 to 3438, solved on pool-E's games and its own. Two more families were dropped after the first night under the rule registered in `pool_f_prediction.md`: Priessnitz 2.0 lost on time in 230 of its 746 games, and Onyx 2.0 played 407 to 486 Elo below its rating because the binary appears to be a different engine from the one CCRL rated. Their games stay on disk and are left out of the solve. No abnormal endings. |
| 2026-09-26 | Sgurr v9.3-rc1 (checkpoint, not shipped) | 3266 | 12 | 1902 | +526 =725 -651 | 10+0.1 | pool-2026-09-E | Ryzen 7 7800X3D, 7 threads | **3266.3 ±11.9**, **+47.2 ±16.5 over v9.2-rc in the same solve** and +81.2 over v9.1. v9.2-rc plus batch A (TT in quiescence, PV-node handling), the speed work (accumulator stack, raw picker moves with lazy SEE, eval cache), batch B (singular refinements) and batch D (no pruning shortcuts at PV nodes, mate distance). Those came to about +50 in self-play, so nearly all of it carried over. Binary `sprt_batch_d.exe`, commit 34662b3, net `gen9_screlu_cos_s1.nnue`. No abnormal endings. **Systematic on pool-E is about ±35, not the ±25 in the two rows below:** the nine anchors imply ratings for Sgurr about 52 Elo apart beyond sampling noise, measured on this run and on v9.1's, which averages to about ±35 over nine families. The interval shown is sampling only. |
| 2026-09-25 | Sgurr v9.2-rc (release candidate, not shipped) | 3219 | 11 | 1988 | +476 =658 -854 | 10+0.1 | pool-2026-09-E | Ryzen 7 7800X3D, 7 threads | **3219.4 ±11.3**, **+33.9 ±16.4 over v9.1 in the same solve.** v9.1's search with the null-move eval gate and TT move keeping (self-play +50.5 ±14.2), and the cosine seed-1 net `gen9_screlu_cos_s1.nnue`, SHA-256 `e733e437…` (self-play +14.1 ±12.0). Pool-E shows about 60% of the self-play total. Held back for more search work, to ship as v9.3. No abnormal endings. Interval is sampling only; systematic remains about ±25. |
| 2026-09-25 | Sgurr v9.1 "Dearg" | 3186 | 12 | 1899 | +408 =558 -933 | 10+0.1 | pool-2026-09-E | Ryzen 7 7800X3D, 7 threads | **3185.6 ±11.9**, the first run on pool-E and the baseline for later versions. Same binary and net as the pool-D row below (3206.2), so pool-E reads 20.6 lower, inside the ±25 systematic band. Nine families from 3087 to 3362, solved on pool-E games alone; conditions and anchors in `pool.json`. No abnormal endings. |
| 2026-09-23 | Sgurr v9.1 "Dearg" | 3206 | 12 | 1724 | +411 =899 -414 | 10+0.1 | pool-2026-08-D | Ryzen 7 7800X3D, 7 threads | **3206.2 ±11.8**, **+124.5 vs v9.0 in the same solve** and the largest version gain the project has measured. No new training data: the same 102,011,689 self-play positions as v9.0. Three changes, each measured alone against v9.0 at 1,000 games before being combined: the ten-item v9.0 search batch with SPSA-tuned constants **+90.2 ±16.7**, SCReLU activation at QA=181 **+22.6 ±17.1**, and the two together **+142.3 ±18.7**. The bundle beating the sum of its parts was not expected; the worry had been the opposite, since the batch prunes on static-eval margins that SPSA fitted against the crelu eval distribution. **The batch was never bad, only mis-set:** it measured -1.0 ±21.1 in v9.0 and was held back, with `HistLmrDiv` shipping at 400,000 against a tuned 228. **SCReLU is equally constant-sensitive:** +5.9 ±16.9 at QA=255, +22.6 ±17.1 at QA=181, same code and data. Rejected and left default-off: pawn correction history -1.4 ±16.3, material scaling -10.1 ±17.2. Conditions as the rows below: Hash 256 all engines, generic `8moves_v3.pgn`, five engine families, no forfeits. Net `nets/gen9_screlu.nnue`. Interval is sampling only; systematic remains about ±25. |
| 2026-09-20 | Sgurr v9.0 lambda 0.9 (experimental) | 3071 | 9 | 3253 | +700 =830 -1723 | 10+0.1 | pool-2026-08-D | Ryzen 7 7800X3D, 7 threads | **3071.2 ±9.4**. Curiosity run stopped manually at 3,253 of 5,000 games. Same 102,011,689-position dataset and v9.0 search as the release, changing only lambda 0.8 to 0.9. The released lambda 0.8 network measured **3080.8 ±6.7 in the same solve**, so lambda 0.9 was 9.6 Elo lower, consistent with the earlier direct match. Hash 256, generic `8moves_v3.pgn`, five engine families. Network SHA-256 `cc9d89b9…`. |
| 2026-09-20 | Sgurr v9.0 "Dearg" | 3081 | 7 | 6508 | +1515 =1578 -3415 | 10+0.1 | pool-2026-08-D | Ryzen 7 7800X3D, 7 threads | **3081.2 ±6.7**. Gen9 network trained on 102,011,689 self-play positions. Lambda 0.8 won the seed-0 playoff. Hash 256, generic `8moves_v3.pgn`, five engine families, no bad endings. Three games cut off by a VS Code restart were removed before this solve. |
| 2026-08-10 | Sgurr v8.2 "Thearlaich" | 3012 | 6 | 9890 | +1667 =2035 -6188 | 10+0.1 | pool-2026-08-D | Ryzen 7 7800X3D, 7 threads | **Corrects the 2026-08-05 row above (3058 ±7). The engine did not change; the measurement did.** Three faults in the older setup were found and fixed, and re-measuring under controlled conditions gives **3012.1 ±5.8**, about **45 Elo lower**. **(1) Hash was never pinned.** The gauntlet passed only the time control, so every engine ran at its own default: 8 MB (Bit-Genie, Jet), 64 (4ku, Simbelmyne, Mantissa), 128 (Monolith), 48 (Sgurr). CCRL's published conditions require the same value, 128 or 256, for every engine in a match. An engine on a fraction of the memory it was rated with underperforms its anchor, which inflates the engine under test. Now pinned at 256 for all. **(2) The opening book was chosen by the engine under test.** `testing/book.epd` keeps positions Sgurr's OWN eval scores within ±70cp, so the measurement ran on openings Sgurr believes are balanced; colour-reversed pairs cancel an opening's imbalance but not a biased choice of openings. It was also only 150 positions, and between-opening variance measured **2.96× chance** (score 9%–80% by opening), making the openings a *sample* contributing ~**±15 Elo that no number of games could reduce** while the run quoted ±5.4. Replaced with `8moves_v3.pgn`, 34,700 engine-neutral ECO lines, which also satisfies CCRL's 'any generic, ≤12 moves per side' book condition. Opening-sampling term now ~±0.5. **(3) Two pool engines could not play legal UCI.** Jet 1.2 and Simbelmyne 1.10.0 emit uppercase promotions (`a7a8Q`); fastchess rules them illegal, so they forfeited **167/698 (23.9%)** and **123/697 (17.6%)** of their games. 580 of 4,182 games, 14%, ended in a forfeit. Both are excluded. `testing/engine_gate.py` now blocks this at preflight, along with engines that ignore `position fen` (StockNemo 5.7.0.0 answered `e1g1` to three endgames with no king on e1). **This run: 0 forfeits.** **A finding drawn from the contaminated data was withdrawn:** an apparent 171 Elo disagreement between anchors, reported as evidence that CCRL transfer bias exceeded ±45, was an artefact of Jet's forfeits and established nothing. **Anchor agreement improved, but is not resolved.** Solving each anchor separately: 4ku 3004 ±8, Bit-Genie 3036 ±8, Monolith 3001 ±10, Drofa 2986 ±11, Mantissa 3034 ±10. **Spread 50 Elo** against pool-B's 90, so a wider, more diverse pool under controlled conditions does agree better. The residual is real rather than sampling noise (Bit-Genie ±8 and Drofa ±11 do not overlap), so **systematic uncertainty is ~±25**, down from ~±45 but still four times the sampling error. Cause unattributed: draw rate shows no correlation with the residual (−0.01), opponent strength none (−0.35), mean game length is suggestive (+0.84) but n=5 and not significant. **Not comparable to the rows below.** Every earlier row was measured on pool-B under uncontrolled hash and the self-filtered book. Their version-to-version *gaps* remain valid, being measured inside one solve, but the whole pool-B ladder is now known to sit ~45 Elo high in absolute terms. Re-measuring older versions under pool-D conditions is owed. Conditions: Hash 256 all engines, `8moves_v3.pgn` (sha256 5835239f…), pondering off, 1 CPU, 10+0.1, concurrency 7, idle machine. Converged: 3012.6 at 7,256 games → 3012.1 at 9,890. |
...
- **Result:** **Sgurr v8.1 = 3026.7 ±11.1** (+2492 =388 −576, 77.7%).
  **+20.9 vs v8.0 in the same solve** (3005.8 ±10.6).
...
- **Two instruments, no compression.** Self-play SPRT +21.2 ±8.7 (4,000 games
  ...
  changes, which can overfit to playing a mirror of yourself. A faster binary
  is the same engine and transfers perfectly across opponents.
- **The 3000 milestone, settled.** v8.0's interval [2995, 3016] straddled 3000
...
- SPRT vs v7.0 @ 8+0.08: +126.5 +/-26.6, verdict H1.
- Pool calibration: 3014 +/-40 (246 games, Ordo over all accumulated calibration PGNs).
