...
private:
    void add_pawn_move(std::vector<Move>& moves, int from_sq, int to_sq, int colour);
    ...
    void add_knight_moves(std::vector<Move>& moves, int piece, U64 own);
    void add_king_moves(std::vector<Move>& moves, int piece, U64 own);
