...
cache. Search is extremely branch-heavy, so PGO carries most of the win.
    ...
    SGR_EVALFILE=../nets/gen9_screlu_cos_s1.nnue ./sgr_prof.exe bench 13
...
A network is tied to the build that trained it. v9.1 and later use SCReLU at QA=181;
...
|---|---|---|
| v9.2 and later | `nets/gen9_screlu_cos_s1.nnue` | defaults, no flags needed |
| v9.1 | `nets/gen9_screlu.nnue` | defaults, no flags needed |
