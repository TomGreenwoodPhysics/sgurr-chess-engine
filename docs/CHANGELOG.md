...
games. Inconclusive rather than negative, but an interval spanning −22 to +20 makes
...
- The absolute figure is cross-hardware: v6.0 and earlier were measured on an
