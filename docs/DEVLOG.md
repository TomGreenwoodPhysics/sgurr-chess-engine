...
Audited gen1's dataset while at it, and found 97% unique positions: the old data was
...
at +47 to +55 the whole run. The punchline writes itself: the same 6M positions
