...
| 5 | **SPSA: everything else** | +20 to +40 | the remaining 22 parameters. Exclude the time-management block or tune it against the pool, §6 records the v3.1 soft limit at +24.6 self-play and NEGATIVE pooled |
