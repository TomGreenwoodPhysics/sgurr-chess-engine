...
const CORE_THINKING_LINES = [
  ...
  "Updating the principal variation...",
  "Checking forcing moves...",
  "Evaluating king safety...",
  "Comparing root moves...",
  "Completing the current depth...",
];
...
const CORE_DIALOGUE_LINES = {
  ...
  engineCheck: [],
  humanCheck: [],
  engineSwing: ["Evaluation shifted towards Sgurr."],
  humanSwing: ["Evaluation shifted towards you."],
  mateThreat: ["Sgurr found a forced mate."],
  sgurrWin: ["Sgurr wins."],
  humanWin: ["You win."],
  draw: ["Draw."],
};
...
const OPENING_BOOK = [
  {
    ...
    line: "Opening: Sicilian Defence, Najdorf Variation.",
  },
  {
    key: "sicilian_dragon",
    name: "Sicilian Defence: Dragon",
    moves: ["e2e4", "c7c5", "g1f3", "d7d6", "d2d4", "c5d4", "f3d4", "g8f6", "b1c3", "g7g6"],
    line: "Opening: Sicilian Defence, Dragon Variation.",
  },
  { key: "sicilian", name: "Sicilian Defence", moves: ["e2e4", "c7c5"], line: "Opening: Sicilian Defence." },
  { key: "french", name: "French Defence", moves: ["e2e4", "e7e6"], line: "Opening: French Defence." },
  { key: "caro_kann", name: "Caro-Kann Defence", moves: ["e2e4", "c7c6"], line: "Opening: Caro-Kann Defence." },
  { key: "scandinavian", name: "Scandinavian Defence", moves: ["e2e4", "d7d5"], line: "Opening: Scandinavian Defence." },
  {
    key: "pirc",
    name: "Pirc Defence",
    moves: ["e2e4", "d7d6", "d2d4", "g8f6", "b1c3", "g7g6"],
    line: "Opening: Pirc Defence.",
  },
  { key: "italian", name: "Italian Game", moves: ["e2e4", "e7e5", "g1f3", "b8c6", "f1c4"], line: "Opening: Italian Game." },
  { key: "ruy_lopez", name: "Ruy Lopez", moves: ["e2e4", "e7e5", "g1f3", "b8c6", "f1b5"], line: "Opening: Ruy Lopez." },
  { key: "scotch", name: "Scotch Game", moves: ["e2e4", "e7e5", "g1f3", "b8c6", "d2d4"], line: "Opening: Scotch Game." },
  { key: "petrov", name: "Petrov Defence", moves: ["e2e4", "e7e5", "g1f3", "g8f6"], line: "Opening: Petrov Defence." },
  { key: "open_game", name: "Open Game", moves: ["e2e4", "e7e5"], line: "Opening: Open Game." },
  { key: "queens_gambit", name: "Queen's Gambit", moves: ["d2d4", "d7d5", "c2c4"], line: "Opening: Queen's Gambit." },
  { key: "slav", name: "Slav Defence", moves: ["d2d4", "d7d5", "c2c4", "c7c6"], line: "Opening: Slav Defence." },
  { key: "london", name: "London System", moves: ["d2d4", "d7d5", "c1f4"], line: "Opening: London System." },
  { key: "kings_indian", name: "King's Indian Defence", moves: ["d2d4", "g8f6", "c2c4", "g7g6"], line: "Opening: King's Indian Defence." },
  { key: "nimzo_indian", name: "Nimzo-Indian Defence", moves: ["d2d4", "g8f6", "c2c4", "e7e6", "b1c3", "f8b4"], line: "Opening: Nimzo-Indian Defence." },
  { key: "grunfeld", name: "Grunfeld Defence", moves: ["d2d4", "g8f6", "c2c4", "g7g6", "b1c3", "d7d5"], line: "Opening: Grunfeld Defence." },
  { key: "dutch", name: "Dutch Defence", moves: ["d2d4", "f7f5"], line: "Opening: Dutch Defence." },
  { key: "english", name: "English Opening", moves: ["c2c4"], line: "Opening: English Opening." },
  { key: "reti", name: "Reti Opening", moves: ["g1f3"], line: "Opening: Reti Opening." },
  { key: "queens_pawn", name: "Queen's Pawn Game", moves: ["d2d4"], line: "Opening: Queen's Pawn Game." },
  { key: "kings_pawn", name: "King's Pawn Game", moves: ["e2e4"], line: "Opening: King's Pawn Game." },
];
